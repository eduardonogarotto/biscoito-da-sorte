const screen1 = document.querySelector(".home")
const screen2 = document.querySelector(".sorte")
const luckyMessage = document.querySelector(".luckyMessage")
const getLucky = document.querySelector(".getLucky")
...
function newMessage(){
  luckyMessage.innerText = phrases[randomNumber]
...
getLucky.addEventListener("click", handleClick)
